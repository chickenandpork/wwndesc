...
{
    BigInteger wwn;	/**< the WWN that the instance tried to describe */
    boolean brief;	/**< whether a more brief output should be offered in @ref toString() .. the class may choose to ignore this value */

    /**
     * create an instance with this.brief set to false.  This is a convenience function to support the older constructor model
     * 
