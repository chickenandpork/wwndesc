...
\begin{center}
\leavevmode
\includegraphics[width=208pt]{classorg_1_1smallfoot_1_1wwn_1_1WWNDescription_1_1DemoTestDesc__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=262pt]{classorg_1_1smallfoot_1_1wwn_1_1WWNDescription_1_1DemoTestDesc__coll__graph}
\end{center}
\end{figure}
