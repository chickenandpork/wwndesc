...
java/wwndesc.\+jar is the proper built jar file; convjars is where \char`\"{}convenience jars\char`\"{} are built if you\textquotesingle{}re less concerned with license purity and more concerned with\+:
...
We\textquotesingle{}ve all been there. In both cases. grab convjars/wwndesc.\+jar, it\textquotesingle{}s not sanitary, but it works.
...
The basic structure of this project is where W\+W\+N\+Description\textquotesingle{}s ({\tt http\+://chickenandpork.\+github.\+io/wwndesc/classorg\+\_\+1\+\_\+1smallfoot\+\_\+1\+\_\+1wwn\+\_\+1\+\_\+1\+W\+W\+N\+Description.\+html}) get\+W\+W\+N\+Descriptor(\+String wwn) searches through a maintained list of W\+W\+N\+Desc descendents for a O\+U\+I or pattern that matches; the W\+W\+N\+Desc descendent is instantiated, and returned, or get\+W\+W\+N\+Description() returns a null.
