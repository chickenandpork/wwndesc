...
\begin{center}
\leavevmode
\includegraphics[width=190pt]{classorg_1_1smallfoot_1_1wwn_1_1IBMSVCDescription__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=253pt]{classorg_1_1smallfoot_1_1wwn_1_1IBMSVCDescription__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyParams}{Parameters}
{\em strong} & is used to show only those patterns we\textquotesingle{}re 100\% certain about\+: this class is a strong representation of 505076801$\ast$, but a weak representation of all 50507680$\ast$ (notice that the last nibble is fuzzy, meaning we could get duplicate names) \\
\hline
