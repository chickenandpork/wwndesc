...
\item 
class {\bf W\-W\-N\-Desc}
\begin{DoxyCompactList}\small\item\em \doxyref{W\-W\-N\-Desc}{p.}{classorg_1_1smallfoot_1_1wwn_1_1WWNDesc} is the basic generic class from which each vendor-\/specific pattern is built upon; similar to an abstract parent but populated methods. \end{DoxyCompactList}\end{DoxyCompactItemize}
