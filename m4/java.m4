dnl
dnl from http://www.opensource.apple.com/source/subversion/subversion-35/subversion/build/ac-macros/java.m4
dnl
...
[
  ...
  dnl See <a href="http://developer.apple.com/qa/qa2001/qa1170.html">http://developer.apple.com/qa/qa2001/qa1170.html</a>
  os_arch="`uname`"
  ...
  if test "$os_arch" = "Darwin" && test -d "/Library/Java/JavaVirtualMachines/jdk1.8.0.jdk/Contents/Home/include"; then
  ...
  elif test "$os_arch" = "Darwin" && test -d "/Library/Java//JavaVirtualMachines/1.6.0_29-b11-402.jdk/Contents/Home/include"; then
